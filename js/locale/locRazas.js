...
var SYLV_VISION_DESC = (new L("SYLV_VISION_DESC","Sufre un penalizador de -3 a los puntos de experiencia que obtenga al finalizar una sesión de juego.",
    "Sufre un penalizador de -3 a los puntos de experiencia que obtenga al finalizar una sesión de juego.")).getId();
var RAZA_NEPH_DAIMAH = (new L("RAZA_NEPH_DAIMAH","Nephilim Daimah",
    "Nephilim Daimah")).getId();
var DAIM_NEPH_SENTIR = (new L("DAIM_NEPH_SENTIR","Sentir el bosque (Nephilim Daimah)",
    "Sentir el bosque (Nephilim Daimah)")).getId();
var DAIM_NEPH_MOVIMIENTO = (new L("DAIM_NEPH_MOVIMIENTO","Movimiento por los bosques (Nephilim Daimah)",
    "Movimiento por los bosques (Nephilim Daimah)")).getId();
var DAIM_NEPH_VER = (new L("DAIM_NEPH_VER","Ver la esencia (Nephilim Daimah)",
    "Ver la esencia (Nephilim Daimah)")).getId();
var DAIM_NEPH_PEQUEÑO = (new L("DAIM_NEPH_PEQUEÑO","Pequeño tamaño (Nephilim Daimah)",
    "Pequeño tamaño (Nephilim Daimah)")).getId();
var DAIM_NEPH_NATURALEZA = (new L("DAIM_NEPH_NATURALEZA","Naturaleza curativa (Nephilim Daimah)",
    "Naturaleza curativa (Nephilim Daimah)")).getId();
var DAIM_NEPH_ALMA = (new L("DAIM_NEPH_ALMA","Alma inmortal (Nephilim Daimah)",
    "Alma inmortal (Nephilim Daimah)")).getId();
...
var RAZA_NEPH_DANJAYNI = (new L("RAZA_NEPH_DANJAYNI","Nephilim D'Anjayni",
    "Nephilim D'Anjayni")).getId();
var DANJ_NEPH_INDETECTABILIDAD = (new L("DANJ_NEPH_INDETECTABILIDAD","Indetectabilidad (Nephilim D'Anjayni)",
    "Indetectabilidad (Nephilim D'Anjayni)")).getId();
var DANJ_NEPH_OLVIDO = (new L("DANJ_NEPH_OLVIDO","Olvido (Nephilim D'Anjayni)",
    "Olvido (Nephilim D'Anjayni)")).getId();
var DANJ_NEPH_SUSURROS = (new L("DANJ_NEPH_SUSURROS","Susurros silenciosos (Nephilim D'Anjayni)",
    "Susurros silenciosos (Nephilim D'Anjayni)")).getId();
var DANJ_NEPH_PASAR = (new L("DANJ_NEPH_PASAR","Pasar sin dejar rastro (Nephilim D'Anjayni)",
    "Pasar sin dejar rastro (Nephilim D'Anjayni)")).getId();
var DANJ_NEPH_APARIENCIA = (new L("DANJ_NEPH_APARIENCIA","Apariencia común (Nephilim D'Anjayni)",
    "Apariencia común (Nephilim D'Anjayni)")).getId();
var DANJ_NEPH_ALMA = (new L("DANJ_NEPH_ALMA","Alma inmortal (Nephilim D'Anjayni)",
    "Alma inmortal (Nephilim D'Anjayni)")).getId();
...
var RAZA_NEPH_DUKZARIST = (new L("RAZA_NEPH_DUKZARIST","Nephilim Duk'zarist",
    "Nephilim Duk'zarist")).getId();
var DUK_NEPH_RESISTENCIAS = (new L("DUK_NEPH_RESISTENCIAS","Resistencias excepcionales (Nephilim Duk'zarist)",
    "Resistencias excepcionales (Nephilim Duk'zarist)")).getId();
var DUK_NEPH_DESEQUILIBRIO = (new L("DUK_NEPH_DESEQUILIBRIO","Desequilibrio hacia la Oscuridad (Nephilim Duk'zarist)",
    "Desequilibrio hacia la Oscuridad (Nephilim Duk'zarist)")).getId();
var DUK_NEPH_AGUANTE = (new L("DUK_NEPH_AGUANTE","Aguante a la Muerte (Nephilim Duk'zarist)",
    "Aguante a la Muerte (Nephilim Duk'zarist)")).getId();
var DUK_NEPH_CURACION = (new L("DUK_NEPH_CURACION","Curación Rápida (Nephilim Duk'zarist)",
    "Curación Rápida (Nephilim Duk'zarist)")).getId();
var DUK_NEPH_NECESIDADES = (new L("DUK_NEPH_NECESIDADES","Necesidades Limitadas (Nephilim Duk'zarist)",
    "Necesidades Limitadas (Nephilim Duk'zarist)")).getId();
var DUK_NEPH_PRESENTIR = (new L("DUK_NEPH_PRESENTIR","Presentir lo oscuro y lo luminoso (Nephilim Duk'zarist)",
    "Presentir lo oscuro y lo luminoso (Nephilim Duk'zarist)")).getId();
var DUK_NEPH_VISION = (new L("DUK_NEPH_VISION","Visión nocturna (Nephilim Duk'zarist)",
    "Visión nocturna (Nephilim Duk'zarist)")).getId();
var DUK_NEPH_FUEGO = (new L("DUK_NEPH_FUEGO","Devoción al Fuego (Nephilim Duk'zarist)",
    "Devoción al Fuego (Nephilim Duk'zarist)")).getId();
var DUK_NEPH_CUERPOS = (new L("DUK_NEPH_CUERPOS","Cuerpos perfectos (Nephilim Duk'zarist)",
    "Cuerpos perfectos (Nephilim Duk'zarist)")).getId();
var DUK_NEPH_ALERGIA = (new L("DUK_NEPH_ALERGIA","Alergia al Metal (Nephilim Duk'zarist)",
    "Alergia al Metal (Nephilim Duk'zarist)")).getId();
var DUK_NEPH_ALMA = (new L("DUK_NEPH_ALMA","Alma inmortal (Nephilim Duk'zarist)",
    "Alma inmortal (Nephilim Duk'zarist)")).getId();
...
var RAZA_NEPH_EBUDAN = (new L("RAZA_NEPH_EBUDAN","Nephilim Ebudan",
    "Nephilim Ebudan")).getId();
var EBUD_NEPH_ORINIE = (new L("EBUD_NEPH_ORINIE","Or'inie (Nephilim Ebudan)",
    "Or'inie (Nephilim Ebudan)")).getId();
var EBUD_NEPH_ALAS = (new L("EBUD_NEPH_ALAS","Alas de Serafín (Nephilim Ebudan)",
    "Alas de Serafín (Nephilim Ebudan)")).getId();
var EBUD_NEPH_ESENCIA = (new L("EBUD_NEPH_ESENCIA","Esencia Celestial (Nephilim Ebudan)",
    "Esencia Celestial (Nephilim Ebudan)")).getId();
var EBUD_NEPH_ALMA = (new L("EBUD_NEPH_ALMA","Alma inmortal (Nephilim Ebudan)",
    "Alma inmortal (Nephilim Ebudan)")).getId();
...
var RAZA_NEPH_JAYAN = (new L("RAZA_NEPH_JAYAN","Nephilim Jayán",
    "Nephilim Jayán")).getId();
var JAY_NEPH_GIGANTES = (new L("JAY_NEPH_GIGANTES","Gigantes (Nephilim Jayán)",
    "Gigantes (Nephilim Jayán)")).getId();
var JAY_NEPH_CANSANCIO = (new L("JAY_NEPH_CANSANCIO","Aguante al cansancio (Nephilim Jayán)",
    "Aguante al cansancio (Nephilim Jayán)")).getId();
var JAY_NEPH_RESISTENCIA = (new L("JAY_NEPH_RESISTENCIA","Resistencia al daño (Nephilim Jayán)",
    "Resistencia al daño (Nephilim Jayán)")).getId();
var JAY_NEPH_FUERZA = (new L("JAY_NEPH_FUERZA","Fuerza descomunal (Nephilim Jayán)",
    "Fuerza descomunal (Nephilim Jayán)")).getId();
var JAY_NEPH_VISION = (new L("JAY_NEPH_VISION","Visión espiritual (Nephilim Jayán)",
    "Visión espiritual (Nephilim Jayán)")).getId();
var JAY_NEPH_DEBILIDAD = (new L("JAY_NEPH_DEBILIDAD","Debilidad contra la magia (Nephilim Jayán)",
    "Debilidad contra la magia (Nephilim Jayán)")).getId();
var JAY_NEPH_ALMA = (new L("JAY_NEPH_ALMA","Alma inmortal (Nephilim Jayán)",
    "Alma inmortal (Nephilim Jayán)")).getId();
...
var RAZA_NEPH_SYLVAIN = (new L("RAZA_NEPH_SYLVAIN","Nephilim Sylvain",
    "Nephilim Sylvain")).getId();
var SYLV_NEPH_RESISTENCIAS = (new L("SYLV_NEPH_RESISTENCIAS","Resistencias excepcionales (Nephilim Sylvain)",
    "Resistencias excepcionales (Nephilim Sylvain)")).getId();
var SYLV_NEPH_DESEQUILIBRIO = (new L("SYLV_NEPH_DESEQUILIBRIO","Desequilibrio hacia la Luz (Nephilim Sylvain)",
    "Desequilibrio hacia la Luz (Nephilim Sylvain)")).getId();
var SYLV_NEPH_CURACION = (new L("SYLV_NEPH_CURACION","Curación Rápida (Nephilim Sylvain)",
    "Curación Rápida (Nephilim Sylvain)")).getId();
var SYLV_NEPH_PRESENTIR = (new L("SYLV_NEPH_PRESENTIR","Presentir lo oscuro y lo luminoso (Nephilim Sylvain)",
    "Presentir lo oscuro y lo luminoso (Nephilim Sylvain)")).getId();
var SYLV_NEPH_NECESIDADES = (new L("SYLV_NEPH_NECESIDADES","Necesidades Limitadas (Nephilim Sylvain)",
    "Necesidades Limitadas (Nephilim Sylvain)")).getId();
var SYLV_NEPH_ALMA = (new L("SYLV_NEPH_ALMA","Alma inmortal (Nephilim Sylvain)",
    "Alma inmortal (Nephilim Sylvain)")).getId();
