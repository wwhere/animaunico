...
CATEGORIA_CONJURADOR.bonosInnatos = [
    ...
    new Bono(BONO_HABILIDAD,HB_VALORACION_MAGICA,5,"",true,BONO_INNATO,ORIGEN_CATEGORIA,{categoriaPersonaje:CAT_CONJURADOR}),
    new Bono(BONO_HABILIDAD,HB_OCULTISMO,10,"",true,BONO_INNATO,ORIGEN_CATEGORIA,{categoriaPersonaje:CAT_CONJURADOR})
];
